...
/// @dev Addresses copied from Aave public listings at the time of authoring.
///      No external imports; all constants are raw addresses to keep compilation simple.
library AaveV3Sepolia {
    /// @notice PoolAddressesProvider (resolve the current Pool proxy)
    /// @dev https://sepolia.etherscan.io/address/0x012bAC54348C0E635dCAc9D5FB99f06F24136C9A
    address internal constant POOL_ADDRESSES_PROVIDER = 0x012bAC54348C0E635dCAc9D5FB99f06F24136C9A;

    /// @notice Pool proxy (IPool)
    /// @dev https://sepolia.etherscan.io/address/0x6Ae43d3271ff6888e7Fc43Fd7321a503ff738951
    address internal constant POOL = 0x6Ae43d3271ff6888e7Fc43Fd7321a503ff738951;

    /// @notice PoolConfigurator proxy
    /// @dev https://sepolia.etherscan.io/address/0x7Ee60D184C24Ef7AfC1Ec7Be59A0f448A0abd138
    address internal constant POOL_CONFIGURATOR = 0x7Ee60D184C24Ef7AfC1Ec7Be59A0f448A0abd138;

    /// @notice Aave Oracle
    /// @dev https://sepolia.etherscan.io/address/0x2da88497588bf89281816106C7259e31AF45a663
    address internal constant ORACLE = 0x2da88497588bf89281816106C7259e31AF45a663;

    /// @notice ACL Admin (EOA or contract that holds admin rights)
    /// @dev https://sepolia.etherscan.io/address/0xfA0e305E0f46AB04f00ae6b5f4560d61a2183E00
    address internal constant ACL_ADMIN = 0xfA0e305E0f46AB04f00ae6b5f4560d61a2183E00;

    /// @notice ACL Manager
    /// @dev https://sepolia.etherscan.io/address/0x7F2bE3b178deeFF716CD6Ff03Ef79A1dFf360ddD
    address internal constant ACL_MANAGER = 0x7F2bE3b178deeFF716CD6Ff03Ef79A1dFf360ddD;

    /// @notice Protocol Data Provider (reserve token discovery)
    /// @dev https://sepolia.etherscan.io/address/0x3e9708d80f7B3e43118013075F7e95CE3AB31F31
    address internal constant AAVE_PROTOCOL_DATA_PROVIDER = 0x3e9708d80f7B3e43118013075F7e95CE3AB31F31;

    /// @notice Pool implementation (behind the proxy)
    /// @dev https://sepolia.etherscan.io/address/0x0562453c3DAFBB5e625483af58f4E6D668c44e19
    address internal constant POOL_IMPL = 0x0562453c3DAFBB5e625483af58f4E6D668c44e19;

    /// @notice PoolConfigurator implementation (behind the proxy)
    /// @dev https://sepolia.etherscan.io/address/0x63Dea961A0B2e2dF4F7A4bb61CBc39BF53A6eb32
    address internal constant POOL_CONFIGURATOR_IMPL = 0x63Dea961A0B2e2dF4F7A4bb61CBc39BF53A6eb32;

    /// @notice Default incentives controller
    /// @dev https://sepolia.etherscan.io/address/0x4DA5c4da71C5a167171cC839487536d86e083483
    address internal constant DEFAULT_INCENTIVES_CONTROLLER = 0x4DA5c4da71C5a167171cC839487536d86e083483;

    /// @notice Emission manager
    /// @dev https://sepolia.etherscan.io/address/0x098a890BAfDf6FB4ACD24bF107D20EA15D229C62
    address internal constant EMISSION_MANAGER = 0x098a890BAfDf6FB4ACD24bF107D20EA15D229C62;

    /// @notice Collector
    /// @dev https://sepolia.etherscan.io/address/0x604264f8017fEF3b11B3dD63537CB501560380B5
    address internal constant COLLECTOR = 0x604264f8017fEF3b11B3dD63537CB501560380B5;

    /// @notice Default aToken implementation
    /// @dev https://sepolia.etherscan.io/address/0x48424f2779be0f03cDF6F02E17A591A9BF7AF89f
    address internal constant DEFAULT_A_TOKEN_IMPL = 0x48424f2779be0f03cDF6F02E17A591A9BF7AF89f;

    /// @notice Default variable debt token implementation
    /// @dev https://sepolia.etherscan.io/address/0x54bdE009156053108E73E2401aEA755e38f92098
    address internal constant DEFAULT_VARIABLE_DEBT_TOKEN_IMPL = 0x54bdE009156053108E73E2401aEA755e38f92098;

    /// @notice Testnet Faucet
    /// @dev https://sepolia.etherscan.io/address/0xC959483DBa39aa9E78757139af0e9a2EDEb3f42D
    address internal constant FAUCET = 0xC959483DBa39aa9E78757139af0e9a2EDEb3f42D;

    /// @notice UI providers & helpers
    /// @dev https://sepolia.etherscan.io/address/0xBA25de9a7DC623B30799F33B770d31B44c2C3b77
    address internal constant UI_INCENTIVE_DATA_PROVIDER = 0xBA25de9a7DC623B30799F33B770d31B44c2C3b77;

    /// @dev https://sepolia.etherscan.io/address/0x69529987FA4A075D0C00B0128fa848dc9ebbE9CE
    address internal constant UI_POOL_DATA_PROVIDER = 0x69529987FA4A075D0C00B0128fa848dc9ebbE9CE;

    /// @notice Wallet balance provider
    /// @dev https://sepolia.etherscan.io/address/0xCD4e0d6D2b1252E2A709B8aE97DBA31164C5a709
    address internal constant WALLET_BALANCE_PROVIDER = 0xCD4e0d6D2b1252E2A709B8aE97DBA31164C5a709;

    /// @notice WETH Gateway (ETH<->WETH helper)
    /// @dev https://sepolia.etherscan.io/address/0x387d311e47e80b498169e6fb51d3193167d89F7D
    address internal constant WETH_GATEWAY = 0x387d311e47e80b498169e6fb51d3193167d89F7D;

    /// @notice Legacy StaticATokenFactory
    /// @dev https://sepolia.etherscan.io/address/0xd210dFB43B694430B8d31762B5199e30c31266C8
    address internal constant LEGACY_STATIC_A_TOKEN_FACTORY = 0xd210dFB43B694430B8d31762B5199e30c31266C8;

    /// @notice GHO UI Data Provider
    /// @dev https://sepolia.etherscan.io/address/0x69B9843A16a6E9933125EBD97659BA3CCbE2Ef8A
...
library AaveV3SepoliaAssets {
    ...
    address internal constant LINK_INTEREST_RATE_STRATEGY = 0xCA30c502d52F905FB3D04eE60cA48F5A1A89f8dB;
    ...
    address internal constant USDC_INTEREST_RATE_STRATEGY = 0x5CB1008969a2d5FAcE8eF32732e6A306d0D0EF2A;
    ...
    address internal constant WBTC_INTEREST_RATE_STRATEGY = 0xCA30c502d52F905FB3D04eE60cA48F5A1A89f8dB;
    ...
    address internal constant WETH_INTEREST_RATE_STRATEGY = 0xCA30c502d52F905FB3D04eE60cA48F5A1A89f8dB;
    ...
    address internal constant USDT_INTEREST_RATE_STRATEGY = 0x5CB1008969a2d5FAcE8eF32732e6A306d0D0EF2A;
    ...
    address internal constant AAVE_INTEREST_RATE_STRATEGY = 0xCA30c502d52F905FB3D04eE60cA48F5A1A89f8dB;
    ...
    address internal constant EURS_INTEREST_RATE_STRATEGY = 0x5CB1008969a2d5FAcE8eF32732e6A306d0D0EF2A;
